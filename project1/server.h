...
The return value is a memory buffer that the caller must deallocate using free.
...
If a server module exists with this path,
loads the module and returns a server_module structure representing it.
